...
import { useCompletedCharactersActionsOld } from "@/store";
import React from "react";
import { Dialog } from "../Dialog";
import { Button } from "../Button";

export function ResetButtonOld({ level, disabled }: { level: LevelOld; disabled: boolean }) {
  const { resetLevel } = useCompletedCharactersActionsOld();
  return (
    <Dialog>
