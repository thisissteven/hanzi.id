...
const KEY = "completed-characters-old";
const SETTINGS_KEY = "show-uncompleted-only-old";

const useCompletedCharactersStoreOld = create<CompletedCharactersState>()((set) => ({
...
export const useCompletedCharactersOld = () => useCompletedCharactersStoreOld((state) => state.completedCharacters);
export const useShowUncompletedOnlyOld = () => useCompletedCharactersStoreOld((state) => state.showUncompletedOnly);

export const useCompletedCharactersActionsOld = () => useCompletedCharactersStoreOld((state) => state.actions);
