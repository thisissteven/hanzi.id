  ...
  return (
    <div className="absolute right-2 bottom-[3.75rem] md:right-16 md:bottom-2 pointer-events-none peer-focus:opacity-50">
      <div className="flex gap-2 items-center w-fit text-xs">
        <span className="inline-flex items-center rounded-md backdrop-blur-sm bg-gray-400/10 px-2 py-1 font-medium text-gray-400 ring-1 ring-inset ring-gray-400/20">
          {result.words} words
        </span>
        {result.minutes > 0 && (
          <span className="inline-flex items-center rounded-md backdrop-blur-sm bg-gray-400/10 px-2 py-1 font-medium text-gray-400 ring-1 ring-inset ring-gray-400/20">
              ...
              <div className="space-y-2">
                <div className="relative">
                  <input
                    ...
                    className="bg-transparent pl-3 pr-10 py-2 rounded-md border border-subtle ring-offset-black ring-smoke focus:ring-offset-2 focus:ring-2 transition-shadow duration-[200ms] placeholder:text-secondary/50 focus:outline-none w-full"
                    type="text"
