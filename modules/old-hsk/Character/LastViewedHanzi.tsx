...
import { useLastViewedHanziOld, useLastViewedHanziActionsOld } from "@/store/useLastViewedHanziOld";
import { useRouter } from "next/router";
import React from "react";
import { toast } from "sonner";

export function LastViewedHanzi() {
  const { handleValueMismatch, hydrateLastViewedHanzi } = useLastViewedHanziActionsOld();
  const lastViewedHanzi = useLastViewedHanziOld();
