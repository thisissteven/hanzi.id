...
function GeneratedText({ textResult, isLoading }: { textResult: TextResult; isLoading: boolean }) {
      ...
      <div className="flex gap-2 justify-between">
        <div className="flex gap-2">
          <button
            ...
            className="inline-flex items-center rounded-md backdrop-blur-sm bg-gray-400/10 px-4 py-2 font-medium text-secondary ring-1 ring-inset ring-gray-400/20 text-sm disabled:opacity-50 duration-200 active:bg-hovered"
            onClick={() => {
          ...
          <button
            ...
            className="inline-flex items-center rounded-md backdrop-blur-sm bg-gray-400/10 px-4 py-2 font-medium text-secondary ring-1 ring-inset ring-gray-400/20 text-sm disabled:opacity-50 duration-200 active:bg-hovered"
            onClick={() => {
              if (currentPage < textResult.length - 1) setCurrentPage(currentPage + 1);
            }}
          >
            &#8594;
          </button>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            onClick={() => {
              // all pages
              const text = textResult.map((result) => result.text.join("\n")).join("\n");
