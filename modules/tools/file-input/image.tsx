...
export function FileInputImage({
  ...
  return (
    <div
      className={clsx(
        "rounded-md border border-secondary/10 border-dashed w-full",
    ...
    >
            ...
            <div className="mt-2 relative z-10 rounded-md border border-secondary/10 bg-softblack p-4 w-full max-w-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="pr-8 overflow-hidden">
                  ...
                  {fileNames.length > 1 && <p className="mt-0.5 text-secondary">+{fileNames.length - 1} more files</p>}
                </div>
              </div>
            </div>
          )}
      ...
      <div className="mt-2">
        <p className="text-secondary">
          Pastikan file merupakan format <b>.jpg/png/gif/webp</b>
        </p>
      </div>
    </div>
  );
