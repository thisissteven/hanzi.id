...
function SearchIcon() {
  return (
    <svg className="shrink-0" width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export function CommandMenuSearch({
  ...
  return (
    <div className="relative pl-4 pr-2 py-2 flex items-center gap-2">
      ...
      <Command.Input
        ref={ref}
        className="w-full focus:outline-none tracking-wide bg-transparent placeholder:text-placeholder font-light placeholder:text-secondary placeholder:text-sm"
